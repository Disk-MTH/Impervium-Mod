...
public class EntityCustomTNTPrimed extends Entity implements IEntityAdditionalSpawnData

{
	private static final DataParameter<Integer> FUSE = EntityDataManager.<Integer>createKey(EntityCustomTNTPrimed.class, DataSerializers.VARINT);
    @Nullable
